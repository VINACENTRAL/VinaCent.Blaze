...
{
    public abstract class BlazeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BlazeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BlazeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BlazeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BlazeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BlazeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BlazeDbContext, Task<T>> func)
        {
            T result;
